//trampoline simulating the disconnected behaviour 
#include <stdio.h>
#include "tpl_os.h"
...
// Here the following function "reads" an echo corresponding to always 0 (which in my designed controller corresponds to a disconnected device)
